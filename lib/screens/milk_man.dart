...
class MilkMan extends StatefulWidget {
  @override
  _MilkMan createState() => new _MilkMan();
}

class _MilkMan extends State<MilkMan> {
  int results = 0;
...
/*
 if (events.contains(Event(date: _currentDate2))) {
          print("i got that event");
          print(events.first.date);
          print("length before: ");
          print(events.length);

          events.remove(Event(date: date));
          print("length after : ");
          print(events.length);
          print(events);
        }
